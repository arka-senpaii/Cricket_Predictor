document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderResults(d, t1, t2) {
        ...
        // Animate numbers
        countUp(document.getElementById('t1-runs'), d.innings1.runs, 1400);
        countUp(document.getElementById('t1-wkts'), d.innings1.wickets, 900);
        countUp(document.getElementById('t2-runs'), d.innings2.runs, 1400);
        countUp(document.getElementById('t2-wkts'), d.innings2.wickets, 900);
        ...
        scoresChart = new Chart(ctxScores, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Runs',
                        data: [d.innings1.runs, d.innings2.runs],
                    ...
                    {
                        label: 'Wickets',
                        data: [d.innings1.wickets, d.innings2.wickets],
